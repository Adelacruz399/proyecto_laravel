...
return [
    ...
    | proporcionadas por el proveedor de contraseñas para un intento de actualización de contraseña
    | que ha fallado, como un token inválido o una nueva contraseña inválida.
    |
    */
